...
Welcome to my professional data analytics portfolio! Here you'll find comprehensive case studies, interactive dashboards, and analysis projects that demonstrate my ability to extract insights from data and communicate them effectively to stakeholders.

Each project is **self-contained, reproducible, and professionally documented** with complete methodology, findings, and code.

---

## 📊 Quick Overview

- **Data Analyst** with expertise in turning raw data into actionable business intelligence
- **Diverse Tech Stack**: R, SQL, Tableau, Power BI, Excel, Python, and web technologies
- **End-to-End Analytics**: From data cleaning and exploration to visualization and strategic recommendations
- **Business Focus**: All analyses tied to real business questions and measurable impact
...
#### [Mint Classics Inventory Optimization](./projects/mint-classics-analysis/) | **SQL • MySQL • Database Design**
...
#### [Wittig School Database](./projects/wittig-school-analysis/) | **SQL • MySQL • Relational Database**
...
- **R**: ggplot2, tidyverse, dplyr, tidyr, lubridate, R Markdown
- **SQL**: MySQL, complex queries, database design, ERD modeling
- **Python**: pandas, NumPy, matplotlib, seaborn, Jupyter Notebooks
- **Excel**: Power Query, Pivot Tables, Advanced Formulas, Data Visualization

### **Business Intelligence & Visualization**

- **Power BI**: Data modeling, DAX, interactive dashboards, KPI tracking
- **Tableau**: Interactive dashboards, data exploration, storytelling
- **Data Visualization**: ggplot2, matplotlib, seaborn, Plotly

### **Database & Design**

- **MySQL Workbench**: Schema design, EER diagrams, query development
- **Relational Databases**: Normalization, entity relationships, optimization
- **Data Modeling**: Star schema, dimensional modeling, optimization
...
Every project includes clear explanations of:
...
- Dependency lists (requirements.txt, environment.yml)
...
Every analysis connects findings to:
...
Data analyst with a business background passionate about transforming data into value. My philosophy:

1. **Ask the right questions** - Understand business context before diving into data
2. **Explore thoroughly** - Don't assume; let data reveal patterns and insights
3. **Communicate clearly** - Make complex findings accessible to all stakeholders
4. **Recommend actions** - Analytics is only valuable if it drives decisions

**Bachelor's in Business Administration** combined with hands-on experience in analytics, database design, and business intelligence.
...
Click on any project link above to explore:

- Full README with methodology
- Live dashboards and reports
- Source code and queries
- Data documentation
- Visualization gallery

### **For the Full Experience**

Visit the interactive portfolio site: **[zachrodrigue.github.io](https://zachrodrigue.github.io/)**
...
I'd love to hear from you! Let's discuss data, analytics, or potential opportunities:

- 📧 **Email**: [deguenonrodrigue@gmail.com](mailto:deguenonrodrigue@gmail.com)
- 💼 **LinkedIn**: [linkedin.com/in/rodriguezachariedeguenon](https://linkedin.com/in/rodriguezachariedeguenon)
- 📊 **Kaggle**: [kaggle.com/rodriguedeguenon](https://www.kaggle.com/rodriguedeguenon)
- 🐙 **GitHub**: [github.com/zachrodrigue](https://github.com/zachrodrigue)
- 🌐 **Portfolio**: [zachrodrigue.github.io](https://zachrodrigue.github.io/)

---

## 📜 License & Usage

- **Content & Reports**: All Rights Reserved
- **Code & Analysis**: Available for educational and non-commercial use
- **Dashboards**: View-only access via shared links
...
Thank you for exploring my portfolio! If you find value in any project or have feedback, I'd appreciate hearing from you. Data analysis is a journey, and I'm always learning and improving.
